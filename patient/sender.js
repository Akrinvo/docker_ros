...
//   const museId =      "wq3e2y4eaemXqL8hDYWCvId7lPm9ZpM2iNqkRzFlDUE="
  ...
  const webcam =  "SYWGPVytnXXzeJZjErxostswD0Nmucs8LyCqmstkpUY="//"3QiMW+FiMVZEC2FH0lvo59B/Wb+eXczzryPeAc0g/So="//"mcfqQxQNgWg+uTJvteSi5CV5VLWlotQu9LsrCtZaw38="//"U4zMyF8W7p3xcVdltbQHR2GkeHTmjzlfDBRTnq+Nk6c="                                 // "7Dz8KbekX70uLdyXBKJmRNaxp/oGBD9bex5GHpQSuKw=";
  const microphone = "n8Wnw+xIzkG6rHcbDek00gdU6PLfGXrFmX30zLEDh4Q="//"ucHJSqENf40jdAMDTa1uKDugsu6WXI7FEcssa9rEX5A="//"hIGhvZeFwS9SYHnmoA3wPM7Iz0Hz80hddbO79+DEOng=";
...
{
navigator.mediaDevices.getUserMedia({video : true,audio : false}).then(stream=>        // {deviceId:{exact:robotic_camera}}
    {
    Rlocalstream = stream;
     for(const track of stream.getTracks())
     {
